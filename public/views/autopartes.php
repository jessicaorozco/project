...
<head>
<meta charset="UTF-8">
    <title>Rivfarca - Autopartes</title>
...
<section style="height: auto;" id="equioagro" class="card">
    <h2 style="text-align: center;" class="card-title">Autopartes</h2>
        ...
        <div class="col-md-4">
            <div class="card gallery">
                <img class="card-img-top"
                    src="/images/products/<?php echo $mostrar['image']?>"
                    alt="Card image cap" class="img-responsive">
                <div class="card-body">
                    <h6 class="card-title text-center"><?php echo $mostrar['title']?></h>
                    <p class="card-text text-justify description"><?php echo $mostrar['description']?></p>
                    <div class="clearfix form-inline">
                        <span class="badge"><?php echo $mostrar['price']?></span>
                        <span class="badge"><?php echo $mostrar['exist']?></span>
