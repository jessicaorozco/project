...
<body>
  ...
  <div class="container">
        <div class="row">
            ...
            <aside class="col-sm-4">
                ...
                <ul style="font-size:20px" id="carrito" class="list-group"></ul>
                <hr>
                <!-- Precio total -->
                <h2 class="text-right">Total: <span id="total"></span>$</h2>
                <button style="font-size:20px" id="boton-vaciar" class="btn btn-danger">Vaciar</button>
            </aside>
        </div>
    </div>
    </section>
  ...
  <!--  -->
    ...
    <a style="padding: 1rem; cursor: pointer;border-radius: 5rem; box-shadow: 2px 2px 2px 1px rgba(0, 0, 0, 0.2);" class="ir-arriba" >Inicio</a><a style="padding: 1rem;  cursor: pointer; ;border-radius: 3rem; box-shadow: 2px 2px 2px 1px rgba(0, 0, 0, 0.2)" href="/contacto">Contactános</a> Rivfarca © 2021 Copyright: <a class="text-reset fw-bold" href="https://rivfarca.com/">rivfarca.com</a>
  </div>
  </footer>
...
const baseDeDatos = [
    {
        ...
        nombre: 'Aceite 2050W',
        precio: 20,
        imagen: '/public/images/body/products/autopartesuhv/aceitelmv20W50.png'
    },
    {
        id: 2,
        nombre: 'Aditivo',
        precio: 5,
        imagen: '/public/images/body/products/autopartesuhv/aditiodragon.png'
    },
    {
        id: 3,
        nombre: 'Aditivo',
        precio: 5,
        imagen: '/public/images/body/products/autopartesuhv/adtivooctane.png'
    },
    {
        id: 4,
        nombre: 'Kit de tiempo',
        precio: 10,
        imagen: '/public/images/body/products/autopartesuhv/correatensor.png'
    },
    {
        id: 5,
        nombre: 'Kit de Croche',
        precio: 10,
        imagen: '/public/images/body/products/autopartesuhv/discos.png'
    },
    {
        id: 6,
        nombre: 'Filtros',
        precio: 5,
        imagen: '/public/images/body/products/autopartesuhv/filtroswix.png'
    },
    {
        id: 7,
        nombre: 'Levas',
        precio: 10,
        imagen: '/public/images/body/products/autopartesuhv/levas.png'
    },
    {
        id: 8,
        nombre: 'Kit de dirección',
        precio: 10,
        imagen: '/public/images/body/products/autopartesuhv/oscilante.png'
    },
    {
        id: 9,
        nombre: 'Discos',
        precio: 5,
        imagen: '/public/images/body/products/autopartesuhv/pfreamerica.png'
    },
    {
        id: 10,
        nombre: 'Pastillas',
        precio: 5,
        imagen: '/public/images/body/products/autopartesuhv/pfrenosolidaria.png'
    },
    {
        id: 11,
        nombre: 'Dirección',
        precio: 5,
        imagen: '/public/images/body/products/autopartesuhv/sdireccion.png'
    },
    {
        id: 12,
        nombre: 'Descuentos',
        precio: 5,
        imagen: '/public/images/body/products/autopartesuhv/todofrenos.png'
    },
    

];
function addproducts(evento) {
// Anyadimos el Nodo a nuestro carrito
producto.push(evento.target.getAttribute('marcador'))
// // Calculo el total
...
baseDeDatos.forEach((info) => {
    ...
    // Titulo
    const miNodoTitle = document.createElement('h1');
...
total = 0;
localStorage.setItem(this.user, JSON.stringify(this.carrito));
